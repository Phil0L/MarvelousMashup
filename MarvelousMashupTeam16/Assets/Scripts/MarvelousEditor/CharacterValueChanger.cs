...
namespace MarvelousEditor
{
    public class CharacterValueChanger : MonoBehaviour
    {
        ...
        public void TypeChanged(int index)
        {
            if (controller.selectedElement != null)
            {
                DataClasses.Character.Characters characterE = (DataClasses.Character.Characters) Enum.Parse(typeof(DataClasses.Character.Characters), typeDropdown.options[index].text);
