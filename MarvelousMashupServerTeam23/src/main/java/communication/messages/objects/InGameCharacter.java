...
/**
 *  Message-Class, which is responsible to describe the Entity Character which can be placed on
 *  the map
 *  Characters are needed e.g. for GameStateEvents
 *
 *  @author Sarah Engele
 *
 */

public class InGameCharacter extends Entities{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InGameCharacter)) return false;
